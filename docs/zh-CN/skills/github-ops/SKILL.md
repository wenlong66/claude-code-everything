---
name: github-ops
description: "GitHub 仓库运维、自动化与管理。涵盖 issue 分诊、PR 管理、CI/CD 运维、发布管理和安全监控，并通过 gh CLI 执行。适用于用户想管理 GitHub issue、PR、CI 状态、发布、贡献者、陈旧项，或任何超出简单 git 命令的 GitHub 运维任务时。"
origin: ECC
---
