...
description: "开源发布流水线：将私有项目 fork、脱敏并打包，以安全方式公开发布。串联 3 个代理（forker、sanitizer、packager）。触发词：\"/opensource\"、\"open source this\"、\"make this public\"、\"prepare for open source\"。"
origin: ECC
---
